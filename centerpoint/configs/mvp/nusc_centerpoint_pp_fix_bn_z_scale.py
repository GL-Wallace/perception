"""nuScenes 数据集 CenterPoint 单阶段 PointPillars 配置（MVP 变体、非虚拟点、z 轴修正 BN/缩放）。

PointPillars 主干 + CenterHead，仅加载激光雷达点（lidar_only=True、virtual=False）；
assigner 显式带 pc_range/voxel_size，0.2 米柱、点云范围 ±51.2 米、10 帧输入。训练 20 epoch。
"""
import itertools
import logging
