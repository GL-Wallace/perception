"""nuScenes 数据集 CenterPoint 单阶段 VoxelNet 配置（0.075 米体素、DCN 检测头）。

CenterHead 使用可变形卷积（dcn_head=True）增强回归/分类分支；0.075 米体素、点云范围 ±54 米、10 帧输入。
训练 20 epoch，Adam + OneCycle（峰值 lr=0.001）。
"""
import itertools
import logging
